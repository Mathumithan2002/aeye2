...
class _AdvancedSettingsScreenState extends State<AdvancedSettingsScreen> {
              ...
              gradient: const LinearGradient(
                ...
                colors: [
                  Color.fromARGB(
                    ...
                    190,
                    174,
                  ), // Gradient color for the track
                  Color.fromARGB(255, 206, 190, 174),
                ],
              ),
            ),
          ),
          ...
          child: Slider(
            ...
            onChanged: (value) {
              ...
              FlutterVolumeController.setVolume(
                value / 100,
              ); // Convert to 0-1 for FlutterVolumeController
            },
          ),
        ),
      ],
  ...
  void _setInterval(int minutes) {
    ...
    Get.find<FaceDetectionScreenController>().setInterval(
      minutes,
    ); // Call setInterval on the controller
